...
% In Algorithm~\ref{chap1-alg:k-stars}, each user $v_i$ has her neighbor list $\textbf{a}_i$. 
% Based on $\textbf{a}_i$, 
...
\begin{theorem}\label{chap1-thm:k-stars}
  ...
  % Furthermore, Algorithm~\ref{chap1-alg:k-stars} provides $\varepsilon$-edge LDP.
\end{theorem}
...
\begin{theorem}\label{chap1-thm:subgraph-rr}
  ...
  %Furthermore, Algorithm~\ref{chap1-alg:subgraph-rr} provides $\varepsilon$-edge LDP.
\end{theorem}
...
\begin{theorem}\label{chap1-thm:local2rounds}
  ...
  %Also, Algorithm~\ref{chap1-alg:subgraph-interactive} guarantees $\varepsilon_0 + \varepsilon_1$-edge LDP.
\end{theorem}
