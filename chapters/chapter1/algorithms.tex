...
%   \caption{CountKStars\label{chap1-alg:k-stars}}
  \caption[\alg{LocalLap$_{k\star}$}]{\alg{LocalLap$_{k\star}$}}\label{chap1-alg:k-stars}
\end{algorithm}
...
\caption[Four types of subgraphs with three nodes.]{Four types of subgraphs with three nodes.}
...
\begin{algorithm}
  ...
  \caption[\alg{LocalRR$_\triangle$}]{\alg{LocalRR$_\triangle$}}\label{chap1-alg:subgraph-rr}
\end{algorithm}
...
\begin{algorithm}
  ...
  \caption[\alg{Local2Rounds$_\triangle$}]{\alg{Local2Rounds$_\triangle$}}\label{chap1-alg:subgraph-interactive}
\end{algorithm}
...
\end{tabular}
\caption[Bounds on $l_2$ losses for privately estimating $f_{k\star}$ and $f_{\triangle}$ 
with $\epsilon$-edge LDP.]{Bounds on $l_2$ losses for privately estimating $f_{k\star}$ and
...
%   \includegraphics[width=0.88\linewidth]{fig/MonoCube.pdf}
  ...
  \caption[$(4,2)$-independent cube for given function $f$.]{
    $(4,2)$-independent cube $\calA$ for given function $f$. 
...
\begin{figure}[t]
  ...
  \caption[Construction of an independent cube for a $k$-star function.]{
