...
\chapter{Differentially Private Triangle and 4-Cycle Counting in the Shuffle Model}

\input{chapters/chapter3/macros.tex}
\input{chapters/chapter3/intro}
\input{chapters/chapter3/related}
\input{chapters/chapter3/preliminary}
\input{chapters/chapter3/shuffle}
\input{chapters/chapter3/triangle}
\input{chapters/chapter3/cycle}
