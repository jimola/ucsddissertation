...
\begin{figure}[t]
  ...
  \caption[Overview of our \AlgWSLE{} algorithm.]{Overview of our \AlgWSLE{} (Wedge Shuffling with Local Edges) algorithm with inputs $v_i$ and $v_j$.
...
% \begin{figure}[t]
  ...
  \caption[Overview of our triangle counting algorithm.]{Overview of our triangle counting algorithm.
  We use our
  %wedge shuffle
  \AlgWSLE{}
...
\begin{table}[t]
  \caption[Performance guarantees of one-round triangle counting algorithms providing edge DP.]
	{Performance guarantees of one-round triangle counting algorithms providing edge DP.
