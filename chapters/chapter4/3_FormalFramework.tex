...
\section{Quantifying Robustness}\label{sec:framework}
...
\subsection{Metrics}\label{sec:robustframework}
...
\begin{defn}\label{def:correct}(\textbf{Correctness}) Let 
...
\caption{\DegRRNaive$: \{0,1\}^{n\times n}\mapsto \{\mathbb{N}\cup \{\bot\}\}^n$}\label{alg:degrrnaive}
