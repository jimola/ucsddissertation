...
\begin{table}[t]
\caption[Basic notations.]{Basic notations.}
\centering
\hbox to\hsize{\hfil
\begin{tabular}{l|l}
\hline
...
\begin{figure}[t]
  ...
  \caption[Relative error of one-round algorithms for small datasets ($n=10000$).]
	{Relative error of one-round algorithms for small datasets ($n=10000$).}
...
% the Google+ dataset~\cite{FB} (\GPlus{});
...
\begin{figure}[t]
  ...
  \caption[Examples of two 4-cycles, six 3-stars, and one 2-stars.]{Examples of two 4-cycles, six 3-stars, and one 2-stars.}
